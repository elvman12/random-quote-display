...
function custom_meta_box_markup($object)
{
    ...
    ?>
    	<style>
			#ctd-custom-post-quote input[type=text] {
				padding: 3px 8px;
				font-size: 1.7em;
				line-height: 100%;
				height: 1.7em;
			...
			#normal-sortables {width: 50%;}
			
			#demo-meta-box h2 span {
				font-size: 20px;
				font-weight: 400;
				margin: 0;
...
{
    add_meta_box("demo-meta-box", "Quote Credit (Author)", "custom_meta_box_markup", "quote", "side", "high", null);
}
